...
/**
 * This class Contains getters and setters of details of a person to
 * Get the data from User and Setting it to variables
 * Using CsvBindByName which specifies a binding between a column name of the CSV input and a field in a bean
 * @author sheetal
 * @since 2021-09-10
 */
